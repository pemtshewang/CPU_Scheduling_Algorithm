...
public class Main_Scheduler {
    ...
    public static void Round_Robin() {
        ...
        for(ArrayList<Integer>item:replica)
        {
            System.out.printf("\n%15s %15s %15s %15s %18s %17s",item.get(0),item.get(1),item.get(2),item.get(3),item.get(4),item.get(5));
        }
    ...
    public static void main(String[] args) {
        ...
        switch (ask()) {
            ...
            case 2:
                ...
                break;
            case 3:
                System.out.println("\nYou have selected Priority as the algorithm to solve the problem!");
                Priority();
                break;
            case 4:
